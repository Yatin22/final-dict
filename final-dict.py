...
exlist={
    ...
    'black hat'.upper(): 'Tactics that comply with Google’s Webmaster Guidelines.',
    'black hat': 'Tactics that comply with Google’s Webmaster Guidelines.',
    'black hat'.capitalize(): 'Tactics that comply with Google’s Webmaster Guidelines.',
...
'W'.lower() or 'W'.upper(): '1)webpage 2)website 3)black hat 4)word count ',
    'W'.upper(): '1)webpage 2)website 3)black hat 4)word count',
...
def X():
    ...
    Label(root, text="letters but as we move", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800,
                                                                                                                y=120)
    Label(root, text="forward we will gonna", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800,
                                                                                                               y=160)
    Label(root, text=" update our data", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=200)
    Label(root, text="with alot of new words", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800,
                                                                                                                y=200)
    Label(root, text="", width=20, font="comicansans 12 bold", height=2, bg="black").place(x=800, y=280)
    Label(root, text="", width=20, font="comicansans 12 bold", height=2, bg="black").place(x=800, y=320)
def Y():
...
def Z():
    Label(root, text="As we haven't discovered", width=20, font="comicansans 12 bold", height=2, bg="pink", ).place(x=800, y=80)
    Label(root, text="any words with these ", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=120)
    Label(root, text="letters but as we move", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=120)
    Label(root, text="forward we will gonna", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=160)
    Label(root, text=" update our data", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=200)
    Label(root, text="with alot of new words", width=20, font="comicansans 12 bold", height=2, bg="pink").place(x=800, y=200)
    Label(root, text="", width=20, font="comicansans 12 bold", height=2, bg="black").place(x=800, y=280)
    Label(root, text="", width=20, font="comicansans 12 bold", height=2, bg="black").place(x=800, y=320)
def clk():
    entered = ent.get()
